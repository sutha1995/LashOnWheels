...
Never commit `.env` or service-role keys. Apply the freelancer profile and service catalog migrations before using these flows with real accounts. Booking, payment, portfolio storage, and availability features will be added in later PRD phases.
