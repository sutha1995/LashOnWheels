...
const styles = StyleSheet.create({
  ...
  logo: { borderRadius: 76, height: 152, overflow: 'hidden', width: 152 }, title: { color: theme.colors.ink, fontSize: 26, fontWeight: '800', marginTop: 28 }, body: { color: theme.colors.muted, fontSize: 15, lineHeight: 22, marginTop: 12, maxWidth: 310, textAlign: 'center' }, tagline: { color: theme.colors.ink, fontSize: 11, fontWeight: '800', letterSpacing: 1.5, marginTop: 78 },
